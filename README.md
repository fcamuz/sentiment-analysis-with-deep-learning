...
This machine learning model can provide insights by automatically analyzing product reviews and separating them into tags: Positive and Negative. By using sentiment analysis to structure product reviews, you can:
...
- Loading and Pre-processing (Data Understanding, Data Preperation)
  load_preprocess_data.ipynb consists of functions and code to read the data, remove punctuations,  remove stopwords, lemmatize, tokenize and vectorize. There is also section for EDA. 
  
- Modelling (Modeling and Evaluation)
  model.ipynb has all base models and tuning for best performing model.   
  
- Prediction (Deployment)
  prediction.ipynb consists the pipeline structure for scraping unseen data from Amazon website, pre-   
processing comments and predicting the labels. 
